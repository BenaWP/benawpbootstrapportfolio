...
<div id="post-<?php the_ID(); ?>" <?php post_class( 'post col-md-6' ); ?>>
    ...
    <article class="post-excerpt">
        ...
        <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corporis explicabo aperiam veritatis
            necessitatibus nemo dolore consequatur fugit, non sapiente tempore, commodi voluptatem libero, quae
            repudiandae pariatur totam voluptatum officia aliquid?
        </p>
    </article>
</div>
